...
const scrollers1 = document.querySelectorAll(".bloc-text-slide");
...
function addAnimation() {
  scrollers1.forEach((scroller) => {
    ...
    const scrollerInner = scroller.querySelector(".text-to-flex");
...
const scrollers2 = document.querySelectorAll(".bloc-text-slide-with-image");
